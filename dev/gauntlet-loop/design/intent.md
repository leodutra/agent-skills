...
After: the README credits Matt Shumer for the method and names no other implementation, repository or link; the decisions this skill took against the common alternatives are listed against unnamed alternatives, and the D-entries argue each one. (Amended by the user on 2026-09-19; the first draft of this outcome named two other repositories.)
