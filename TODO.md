...
- [x] 1.3 Add `env.MCP_TIMEOUT` safety net to `~/.claude/settings.json` — set to `"120000"`; takes effect next session, so confirmed by 1.6
...
- [ ] 1.6 Verify: fresh session exposes `mcp__serena__*` tools
